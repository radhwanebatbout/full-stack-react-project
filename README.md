...
![Node.js CI](https://github.com/radhwanebatbout/full-stack-react-project/workflows/Node.js%20CI/badge.svg)
...
1. Clone the repository
   ...
   ```
   git clone https://github.com/radhwanebatbout/full-stack-react-project
   ```
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/radhwanebatbout/full-stack-react-project/blob/master/LICENSE) file for details.
